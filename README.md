...
##### :warning: Currently being refactored; certain features might not work during this process
## Usage
...
##### :information_source: In order to use the Discord bot, you will need to create a Discord bot of your own and copy the value of your client token into the .env file. If you edit the .env or config.json file, you will need to exit out of and relaunch the program

...
# To allow for pyinstaller exe creation
    ...
    def create_window1():
        layout = [[sg.Text('Discord Text to Game Input', font=('Comic Sans MS', 24), pad=(160, 0))],
                ...
                sg.Checkbox("Down", key="3", default=eval(discordConfig["commands"]["down"])), sg.Checkbox("LightDown", key="4", default=eval(discordConfig["commands"]["lightdown"])), 
                sg.Checkbox("Left", key="5", default=eval(discordConfig["commands"]["left"])), sg.Checkbox("LightLeft", key="6", default=eval(discordConfig["commands"]["lightleft"])), 
                sg.Checkbox("Right", key="7", default=eval(discordConfig["commands"]["right"])), sg.Checkbox("LightRight", key="8", default=eval(discordConfig["commands"]["lightright"])), 
                ...
                sg.Checkbox("RESET", key="12", default=eval(discordConfig["commands"]["reset"])), sg.Checkbox("A", key="13", default=eval(discordConfig["commands"]["a"])), 

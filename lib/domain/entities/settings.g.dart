...
void _settingSerialize(
  ...
  writer.writeInt(offsets[3], object.inputType?.index);
  writer.writeString(offsets[4], object.title);
  writer.writeString(offsets[5], object.values);
  writer.writeByte(offsets[6], object.widget.index);
}
...
Setting _settingDeserialize(
  ...
  object.id = id;
  object.inputType =
      _SettinginputTypeValueEnumMap[reader.readIntOrNull(offsets[3])];
  object.title = reader.readString(offsets[4]);
  object.values = reader.readString(offsets[5]);
  object.widget =
      _SettingwidgetValueEnumMap[reader.readByteOrNull(offsets[6])] ??
